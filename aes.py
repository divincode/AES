    ...
    def expandKey(self, key, size, expandedKeySize):
        ...
        while currentSize < expandedKeySize:
            ...
            if currentSize % size == 0:
                ...
                rconIteration += 1
                print  ("t"+str(currentSize//size) + str(t))
...
def testStr(cleartext, keysize=16, modeName = "CBC"):
    ...
    #print(key)
    #print key[0],key[1]
    #print binascii.hexlify(key[0],key[1])
    #print binascii.unhexlify(binascii.hexlify(key[0],key[1]))
    ##key = 
...
if __name__ == "__main__":
    ...
    print "!"
    sss = AES()
    #test_key = [24,75,A2,B3,34,75,56,88,31,E2,12,00,13,AA,54,87]
    test_key1 = [chr(0x24),chr(0x75),chr(0xA2),chr(0xB3),chr(0x34),chr(0x75),chr(0x56),chr(0x88),chr(0x31),chr(0xE2),chr(0x12),chr(0x00),chr(0x13),chr(0xAA),chr(0x54),chr(0x87)]
    str1 = ''.join(test_key1)
    #print(test_key1)
    print(str1)
    str2 = map(ord,str1)
    returned_key = sss.expandKey(str2,sss.keySize["SIZE_128"],176)
    print(returned_key)
    print "length is ",len(returned_key)
    returned = map(hex,returned_key)
    print returned
    print("!!")
